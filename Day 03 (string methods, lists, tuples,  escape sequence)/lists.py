...
randomList.extend(
    ["Samad", "Abdul", "Rehan"]
)  # it will add the elements of the list at the end of the list
randomList.reverse()  # it will reverse the list
randomList.sort()  # it will sort the list
randomList.copy()  # it will copy the list
randomList.count(
    "Samad"
)  # it will return the number of occurrences of the given element
randomList.index(
    "Samad"
)  # it will return the index of the first occurrence of the given element
